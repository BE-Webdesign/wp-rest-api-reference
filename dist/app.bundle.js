...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchReference = function fetchReference() {
		return;
	};

	var getBootstrapReference = function getBootstrapReference() {
		if (sessionStorage) {
			var _referenceData = sessionStorage.getItem('referenceData');
			return JSON.parse(_referenceData);
		}

		var referenceData = fetchReference();

		if (null === referenceData) {
			referenceData = _sample2.default;
		}

		return referenceData;
	};

	var bootstrapReference = (0, _reference2.default)('Main Reference', getBootstrapReference());
...
/***/ function(module, exports) {
	      ...
	      "endpoints": [{
	        ...
	        "args": {
	          ...
	          "orderby": {
	            "required": false,
	            "default": "date",
	            "enum": ["date", "relevance", "id", "include", "title", "slug"],
	          ...
	          "status": {
	            ...
	            "type": "array",
	            "items": {
	              "enum": ["publish", "future", "draft", "pending", "private", "trash", "auto-draft", "inherit", "customize-draft", "any"],
	              "type": "string"
	            }
	          },
	          "categories": {
	        ...
	        "args": {
	          ...
	          "format": {
	            "required": false,
	            "enum": ["standard", "aside", "image", "video", "quote", "link", "gallery", "audio"],
	      ...
	      "endpoints": [{
	        ...
	        "args": {
	          ...
	          "orderby": {
	            "required": false,
	            "default": "date",
	            "enum": ["date", "relevance", "id", "include", "title", "slug", "menu_order"],
	            "description": "Sort collection by object attribute.",
	            "type": "string"
	          },
	          "parent": {
	...
	exports.default = sampleReference;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reference = function Reference(referenceName, referenceData) {
		var name = referenceName;
		var data = referenceData;

		var getRouteNames = function getRouteNames() {
			return Object.keys(data.routes);
		};

		var getRoutes = function getRoutes() {
			return getRouteNames().map(function (routeName) {
				return Object.assign({}, { routeName: routeName }, data.routes[routeName]);
			});
		};

		var getRoutesWithSchema = function getRoutesWithSchema() {
			return getRoutes().filter(function (route) {
				return route.schema;
			});
		};

		var getSchemaTypes = function getSchemaTypes() {
			return (0, _utilities.uniqueArray)(getRoutesWithSchema().map(function (route) {
				return route.schema.title;
			}));
		};

		var getRoutesGroupedBySchemaType = function getRoutesGroupedBySchemaType() {
			return getSchemaTypes().map(function (schemaType) {
				var schema = {
					type: schemaType,
					routes: getRoutesWithSchema().filter(function (route) {
						return schemaType === route.schema.title;
					})
				};
		...
		return {
			...
			getRoutesGroupedBySchemaType: getRoutesGroupedBySchemaType
		};
...
/***/ function(module, exports) {
	...
	/**
	 * Utilities are applicable across different entity types.
	 */
